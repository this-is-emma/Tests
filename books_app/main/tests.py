...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        self.assertEqual(created_author.name, 'Frank Herbert')
    ...
    def test_create_genre(self):
        ...
        created_genre = Genre.query.filter_by(name='Religion').first()
        self.assertIsNotNone(created_genre)
        self.assertEqual(created_genre.name, 'Religion')
    ...
    def test_favorite_book(self):
        ...
        # TODO: Verify that the book with id 1 was added to the user's favorite
